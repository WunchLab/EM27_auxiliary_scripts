...
header = ("UTCDate,UTCTime,Pout, P_raw_voltage")
f=open(file_name, 'a')
...
while not leave_loop:
    ...
    try:
      ...
      pprint=round(P,2)
      vprint=round(V,4)
      print(measurement_date+ "," +measurement_time+ ","+  str(pprint) + ","+ str(vprint)+"\n")
      string=measurement_date+ "," +measurement_time+ ","+  str(P)[1:-1][1:-1]+","+ str(V)
